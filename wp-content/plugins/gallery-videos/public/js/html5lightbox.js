			...
			inst.readData = function () {
				...
				inst.each(
					function () {
						...
						inst.elemArray.push(
							new Array(fileType, $this.data("href"), $this.data("title"), $this.data("group"), $this.data("width"), $this.data("height"), $this.data("webm"), $this.data("ogg"), $this.data("thumbnail"), $this.data("description"))
						);
					}
				);
			};
