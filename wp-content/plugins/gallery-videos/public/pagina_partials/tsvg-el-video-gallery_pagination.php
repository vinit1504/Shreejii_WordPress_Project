...
--tsvg_p_lm_ff_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_10), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_11), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_12), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_13), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_14), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_bs_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_15), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm__bdc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_16), FILTER_SANITIZE_STRING);?>;
}
...
<script>
    ...
    function paginationGenerate_<?php echo esc_attr( $ts_galleryv_videos_Js_id ); ?>(id = "<?php echo esc_attr( $Total_Soft_vgallery ); ?>") {
        ...
        // var next_text = '<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_05);?>';
        // var prev_text ='<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_06);?>'; 
        // var next_icon =''; 
        // var prev_icon =''; 
        // var load_icon =''; 
