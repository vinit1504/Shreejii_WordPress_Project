...
--tsvg_p_lm_bc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_31), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_c_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_32), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_fs_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_33), FILTER_VALIDATE_INT);?>px;
--tsvg_p_lm_ff_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_34), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_35), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_36), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_37), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_38), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_bs_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_39), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm__bdc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_01), FILTER_SANITIZE_STRING);?>;
}
...
echo sprintf("
    <nav class='pagination-outer' data-short-id='%s' data-short-theme='%s'  data-pagination='%s' data-load-vw='%s' data-icon-show='%s' data-load-icon='%s' >
        <ul class='pagination' data-ef='%s' data-vw='%s' data-prev-item='%s' data-next-item='%s' data-load-text='%s'>
        </ul>
    </nav>",
...
<script>
    ...
    function paginationGenerate_<?php echo esc_attr( $ts_galleryv_videos_Js_id ); ?>(id = "<?php echo esc_attr( $Total_Soft_vgallery ); ?>") {
        ...
        // var next_text = '<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_29);?>';
        // var prev_text ='<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_1_30);?>'; 
        // var next_icon =''; 
        // var prev_icon =''; 
        // var load_icon =''; 
        ...
        jQuery('.ts_vgallery_section_<?php echo esc_attr($Total_Soft_vgallery);?>  .pagination').append('<li class="page-item page-item-prev" data-item-number="prev"><a href="javascript:void(0)" class="page-link"  ><span >'+next_text+'</span> <i class="'+next_icon+'"></i></a></li>')
        ...
        jQuery('.ts_vgallery_section_<?php echo esc_attr($Total_Soft_vgallery);?>  .pagination').append('<li class="page-item page-item-next" data-item-number="next"><a href="javascript:void(0)" class="page-link"  ><span >'+prev_text+'</span><i class="'+prev_icon+'"></i></a></li>')
