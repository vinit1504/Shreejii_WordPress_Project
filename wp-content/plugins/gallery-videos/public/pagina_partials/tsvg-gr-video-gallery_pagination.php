...
/* .ts_vgallery_main_<?php echo esc_attr($Total_Soft_vgallery);?>[data-pagination='pagination']  figure ul li{
...
--tsvg_p_lm_bc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_14), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_c_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_15), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_fs_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_16), FILTER_VALIDATE_INT);?>px;
--tsvg_p_lm_ff_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_17), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_18), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_19), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hbc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_20), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_21), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_bs_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_24), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm__bdc_<?php echo esc_attr($Total_Soft_vgallery);?>:<?php echo filter_var(esc_html($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_25), FILTER_SANITIZE_STRING);?>;
}
...
esc_attr( $tsvgallery_TS_VG_Styles->TotalSoft_GV_2_13),
...
<script>
    ...
    function paginationGenerate_<?php echo esc_attr( $ts_galleryv_videos_Js_id ); ?>(id = "<?php echo esc_attr( $Total_Soft_vgallery ); ?>") {
        ...
        // var next_text = '<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_12);?>';
        // var prev_text ='<?php echo  esc_js($tsvgallery_TS_VG_Styles->TotalSoft_GV_2_13);?>'; 
        // var next_icon =''; 
        // var prev_icon =''; 
        // var load_icon =''; 
